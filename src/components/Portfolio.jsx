...
const Portfolio = () => {
  ...
  const projects = [
    {
      ...
      description:
        "The project focuses on predicting daily weather variables for Chennai",
      tech: "Python",
      date: "October - 2024 (Still Working)",
      link: "https://github.com/AyushmanGHub/Daily-Temperature-Prediction-of-Chennai",
      link2: "",
      image:
        "https://raw.githubusercontent.com/AyushmanGHub/Daily-Temperature-Prediction-of-Chennai/refs/heads/main/temperature%20real%20vs%20pred.png",
    },
    {
      title: "From Data to Dwellings: Decoding Amsterdam's Housing Prices",
      description:
        "Under Prof. Sourish Das | Chennai Mathematical Institute, Chennai",
      tech: "Python, ML",
      date: "September - 2024",
      link: "https://github.com/AyushmanGHub/Amsterdam-House-Price-Analysis-and-Prediction",
      link2:
        "https://github.com/AyushmanGHub/Amsterdam-House-Price-Analysis-and-Prediction/blob/main/From%20Data%20to%20Dwellings%20Decoding%20Amsterdams%20Housing%20Prices.pdf",
      image:
        "https://raw.githubusercontent.com/AyushmanGHub/Amsterdam-House-Price-Analysis-and-Prediction/refs/heads/main/resource/01.png",
    },
    {
      title: "Availability, Accessibility and Inequality of WASH in India",
      description:
        "Under Prof. Rituparna Sen |  Indian Statistical Institue, Bangalore",
      tech: "R programming",
      date: "December - 2022",
  ...
  const experience = [
    {
      ...
      description:
        "Subjects : Probability and Statistics, Data Visualization, SQL and RDBMS",
    },
    {
      ...
      description:
        "The PReMI workshop, provided an in-depth exploration of various advanced topics. It included lectures and practical sessions on Optimization, Machine Learning models, Statistical models, and related areas.",
    },
    {
      ...
      logo: "https://www.govtjobsblog.in/wp-content/uploads/2022/05/Indian-Statistical-Institute.png",
      description:
        "Subjects : Probability, Statistics, Statistical Inference, Linear Algebra, Optimization, Economics, Graph Theory, Analysis",
    },
    {
    ...
    <div className="animate-fadeIn">
      ...
      <div className="w-full flex justify-center mt-8 mb-8">
        <button
          ...
          onClick={() =>
            window.open(
              "https://ayushmanghub.github.io/Ayushman%20Official%20CMI%20CV.pdf",
              "_blank"
            )
          } // Update '#' with the actual resume link later
        >
          View Resume
        </button>
      </div>
      ...
      <section className="mb-12">
        ...
        <p className="text-lg">
          I am a Data Science student with a deep passion for learning and
          exploration. Coming from a strong Mathematics background, I have
          developed a keen interest in areas such as Statistics, Probability,
          Statistical Inference, Graph Theory, and Economics. I'm particularly
          enthusiastic about applying my knowledge in data-driven fields like
          machine learning, statistical modelling, and data visualization.
          <br />
          <br />I thrive on solving complex problems and approach every
          challenge with persistence and a never-give-up attitude. With a goal
          to contribute to organizational growth and success, I aim to address
          complex challenges, fostering impactful solutions and advancements.
        </p>
      </section>
      ...
      >
        ...
        <div className="space-y-4 ">
          <div className="">
            ...
            <div className="flex items-center gap-2 mb-3">
              <Mail />
              <a
                href="mailto:ayushmantutu@gmail.com"
          ...
          <div>
            ...
            <div className="flex gap-4 mt-2">
              <a
                href="https://www.linkedin.com/in/ayushman-anupam/"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://github.com/AyushmanGHub"
                target="_blank"
                rel="noopener noreferrer"
              >
        ...
        <div className="mt-8 text-center">
          <p className="flex items-center text-justify">
            Feel free to reach out if you're interested in discussing a variety
            of topics, including projects, industrial work, academic subjects,
            or research. I'm open to engaging in meaningful conversations and
            exchanging ideas on these areas. You can contact me through email,
            which I check regularly, ensuring timely responses. Alternatively,
            you can connect with me on LinkedIn for more networking
            opportunities. I welcome the chance to explore new insights,
            collaborate on projects, and contribute to ongoing discussions in
            these fields. Your thoughts and inquiries are always valued, and I
            look forward to connecting and sharing knowledge.
          </p>
        </div>
  ...
  return (
    ...
    >
      <header
        className={`fixed top-0 left-0 right-0 z-10 p-4 flex justify-between items-center bg-opacity-95 backdrop-filter backdrop-blur-lg ${
      ...
      <main className="container mx-auto px-4 pt-20 pb-8">{renderPage()}</main>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className={`p-2 rounded-full ${
              currentPage === "projects" ? "bg-blue-500 text-white" : ""
            }`}
          ...
          <button
            ...
            className={`p-2 rounded-full ${
              currentPage === "experience" ? "bg-blue-500 text-white" : ""
            }`}
          ...
          <button
            ...
            className={`p-2 rounded-full ${
              currentPage === "gallery" ? "bg-blue-500 text-white" : ""
            }`}
